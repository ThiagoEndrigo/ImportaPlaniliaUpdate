...
const validarAcessoMovNotaItem = (() => {
  const chave = String.fromCharCode(103, 101, 114, 97, 117, 112, 100, 97, 116, 101);
  return tentativa => typeof tentativa === 'string' && tentativa === chave;
})();
...
document.getElementById('confirmMovNotaPasswordBtn').addEventListener('click', () => {
  if (!validarAcessoMovNotaItem(movNotaPasswordInput.value)) {
